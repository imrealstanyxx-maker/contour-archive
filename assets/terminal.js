(() => {
  ...
  // Фрагменты данных - только связанные с KES-001 и KEF-002
  const fragments = [
    ...
    },
    {
      ...
      name: 'kef02.trace',
      level: 0,
      content: 'КЕФ-002: документ заполняется автоматически при попытке редактирования.\nЛюбой ввод заменяется заранее заданным текстом шаблона.\nПользователь не может контролировать содержимое.',
      tags: ['KEF-002']
    },
    {
      id: 'FRAG-00K',
